...
import co.edu.unicauca.gesrotesbackend.models.StudentEntity;
...
public interface StudentRepository extends JpaRepository<StudentEntity, Integer> {
    ...
    List<StudentEntity> getStudentInfo(@Param("asigId") int asigId, @Param("progId") int progId, @Param("cooId") int cooId);
    ...
    @Query(value = "SELECT * " +
            ...
            "      AND ea.coo_id = :cooId" +
            ")", nativeQuery = true)
    List<StudentEntity> getStudentsByName(@Param("cadenaBusqueda") String name, @Param("asigId") int asigId, @Param("progId") int progId, @Param("cooId") int cooId);
