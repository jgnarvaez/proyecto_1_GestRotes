...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_coordinador` (
  ...
  `coo_rol` ENUM('Coordinador_de_asignatura', 'Coordinador_de_programa') NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_est_asignacion` (
  ...
  `asig_id` INT NOT NULL,
  `coo_id` INT NOT NULL,
  `est_asig_estado` ENUM('Registrado', 'No_registrado') NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_matricula` (
  `prog_id` INT NOT NULL,
  `pu_id` INT NOT NULL,
  `mat_estado` ENUM('Matriculado', 'No_matriculado') NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_turno_est_asig`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_turno_est_asig` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tbl_turno_est_asig` (
  `pu_id` INT NOT NULL,
  `prog_id` INT NOT NULL,
  `asig_id` INT NOT NULL,
  `coo_id` INT NOT NULL,
  `tur_id` INT NOT NULL,
  PRIMARY KEY (`pu_id`, `prog_id`, `asig_id`, `coo_id`, `tur_id`),
  INDEX `fk_tbl_est_asignacion_has_tbl_turno_tbl_turno1_idx` (`tur_id` ASC) VISIBLE,
  INDEX `fk_tbl_est_asignacion_has_tbl_turno_tbl_est_asignacion1_idx` (`pu_id` ASC, `prog_id` ASC, `asig_id` ASC, `coo_id` ASC) VISIBLE,
  CONSTRAINT `fk_tbl_est_asignacion_has_tbl_turno_tbl_est_asignacion1`
    FOREIGN KEY (`pu_id` , `prog_id` , `asig_id` , `coo_id`)
    REFERENCES `mydb`.`tbl_est_asignacion` (`pu_id` , `prog_id` , `asig_id` , `coo_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_est_asignacion_has_tbl_turno_tbl_turno1`
    FOREIGN KEY (`tur_id`)
