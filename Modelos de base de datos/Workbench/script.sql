...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_asignatura` (
  ...
  INDEX `fk_tbl_asignatura_tbl_coordinador_asignatura1_idx` (`coo_id` ASC) VISIBLE,
  UNIQUE INDEX `coo_id_UNIQUE` (`coo_id` ASC) VISIBLE,
  CONSTRAINT `fk_tbl_asignatura_tbl_coordinador_asignatura1`
    FOREIGN KEY (`coo_id`)
