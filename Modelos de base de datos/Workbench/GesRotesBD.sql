...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_departamento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_ciudad` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_direccion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_acudiente` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tbl_acudiente` (
  `acu_id` INT NOT NULL AUTO_INCREMENT,
  `acu_nombres` VARCHAR(20) NULL,
  `acu_apellidos` VARCHAR(20) NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_lugar_nac` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_persona_universitaria` (
  ...
  `pu_dni_frontal` VARCHAR(150) NULL,
  `pu_dni_reverso` VARCHAR(150) NULL,
  `pu_carnet_frontal` VARCHAR(150) NULL,
  `pu_carnet_reverso` VARCHAR(150) NULL,
  `pu_foto_perfil` VARCHAR(150) NULL,
  `pu_carnet_vacunas` VARCHAR(150) NULL,
  `dir_id` INT NOT NULL,
  `acu_id` INT NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_grupo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_docente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_vacuna` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_vacuna_persona_universitaria` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_datos_generales` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_formacion_academica` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tbl_formacion_academica` (
  `fac_id` INT NOT NULL AUTO_INCREMENT,
  `fac_titulo` VARCHAR(20) NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_produccion_intelectual` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_datos_academicos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_reconocimiento_academico` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_datos_academicos_estudiante` ;
...
-- Table `mydb`.`tbl_pais`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_pais` ;
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_institucion_exp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_institucion_exp` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tbl_institucion_exp` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_experiencia_docente` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_experiencia_docente` (
  ...
  `expd_certificado` VARCHAR(150) NULL,
  `inst_id` INT NOT NULL,
  PRIMARY KEY (`expd_id`, `inst_id`),
  ...
  CONSTRAINT `fk_tbl_experiencia_docente_tbls_institucion_exp1`
    FOREIGN KEY (`inst_id`)
    REFERENCES `mydb`.`tbl_institucion_exp` (`inst_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_tarjeta_profesional` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tbl_tarjeta_profesional` (
  `tjp_id` INT NOT NULL AUTO_INCREMENT,
  `tjp_tarjeta_frontal` VARCHAR(150) NULL,
  `tjp_tarjeta_reverso` VARCHAR(150) NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_datos_academicos_docente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_idioma` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_manejo_idioma` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_manejo_idioma_has_tbl_datos_academicos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_verificacion_inmunizacion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_requisito_escenario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_verificacion_requisito` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_vacunacion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_titulacion` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_salud_seguridad` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tbl_salud_seguridad` (
  `sase_id` INT NOT NULL AUTO_INCREMENT,
  `sase_doc_eps` VARCHAR(150) NULL,
  `sase_doc_arl` VARCHAR(150) NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_pruebas_realizadas` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_horario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_ciclo` ;
...
-- Table `mydb`.`tbl_rote`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_rote` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_horario_rote` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_docente_rote` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_escenario_persona` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_asignatura_estudiante` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_asignatura_docente` ;
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_institucion_exp_dependencia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_institucion_exp_dependencia` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tbl_institucion_exp_dependencia` (
  `inst_id` INT NOT NULL,
  `depd_id` INT NOT NULL,
  PRIMARY KEY (`inst_id`, `depd_id`),
  INDEX `fk_tbls_institucion_exp_has_tbl_dependencia_tbl_dependencia_idx` (`depd_id` ASC) ,
  INDEX `fk_tbls_institucion_exp_has_tbl_dependencia_tbls_institucio_idx` (`inst_id` ASC) ,
  CONSTRAINT `fk_tbls_institucion_exp_has_tbl_dependencia_tbls_institucion_1`
    FOREIGN KEY (`inst_id`)
    REFERENCES `mydb`.`tbl_institucion_exp` (`inst_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbls_institucion_exp_has_tbl_dependencia_tbl_dependencia1`
    FOREIGN KEY (`depd_id`)
