...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_est_asignacion` (
  ...
  `est_asig_mes` ENUM('Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre') NULL,
  `est_asig_anio` YEAR(4) NULL,
...
BEGIN
	IF NEW.est_asig_seleccionado = 1 AND OLD.est_asig_seleccionado = 0 THEN
